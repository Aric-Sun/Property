...
<head>
    ...
    <script type="text/javascript">
        function searchPaymentRecord() {
            ...
            table = document.getElementById("costRecord_list_table");
...
<div id="data">
    ...
    <%--    </div>--%>
    <%--</div>--%>
    <table class="table table-striped" id="costRecord_list_table">
        <tr>
            <td>用户名</td>
            <td>抄表时间</td>
            <td>水费</td>
